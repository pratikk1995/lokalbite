...
void main() {
  ...
  // Deep navy blue status bar for Store Partner branding
  ...
  runApp(const LokaBitePartnerApp());
}

class LokaBitePartnerApp extends StatelessWidget {
  const LokaBitePartnerApp({super.key});
